							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								<p>
									<label>ID:<?php echo $result['id'];?></label>
										<input class="text-input small-input" type="hidden" id="small-input" name="id" value="<?php echo $result['id'];?>" /><!--$_POST['id'] = $result['id']--> 
										
										<br />
								</p>
								<p>
									<label>标题</label>
										<input class="text-input small-input" type="text" id="small-input" name="title" value="<?php echo $result['title'];?>" /> <!--$_POST['title'] = $result['title']--> 
										<br />
								</p>
								<!--
								<p>
